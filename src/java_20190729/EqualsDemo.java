...
public class EqualsDemo {
	public static void main(String[] args) {
		...
		// c3.equals(c4) 메서드가 true이면 c3, c4의 hashCode값은 같고 
		// c3.equals(c4) 메서드가 false이면 c3, c4의 hashCode값은 달라야 한다.
		...
		HashSet<Car> set = new HashSet<Car>(); //중복되는 개체를 하나로 합쳐줌. Hashcode를 override 하면 1, 안 하면 2.
		set.add(c1);
		set.add(c2);
